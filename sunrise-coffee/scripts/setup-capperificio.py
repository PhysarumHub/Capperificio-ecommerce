...
Uso:
  ...
  python scripts/setup-capperificio.py --base http://localhost:8080 --pass LA_TUA_PASSWORD
  python scripts/setup-capperificio.py --base http://127.0.0.1 --user admin --pass LA_TUA_PASSWORD
"""
